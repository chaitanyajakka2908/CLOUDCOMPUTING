...
conn = MySQLdb.connect(host="localhost",user="root",password="admin123",db="login_info")
...
def signup_student():
	...
	cursor.execute("INSERT INTO student_login (username,student_email,roll_id) VALUES(%s, %s, %s)",(user,email,roll_id))
	conn.commit()
